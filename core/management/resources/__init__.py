...
from .data_discount_coupon import discount_coupons
...
from .data_lodge import lodges, lodgeAmendities, lodgePoliticies, lodgePaymentsMethods, lodge_photos
from .data_room_photo import room_photos