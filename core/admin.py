...
admin.site.register(models.LodgePhoto)
admin.site.register(models.Lodge)
admin.site.register(models.LodgePolicy)
admin.site.register(models.LodgePaymentMethod)
admin.site.register(models.LodgeAmenity)